...
function ConfiguracionAdmin() {
  ...
  const [busquedaLogs, setBusquedaLogs] = useState("");  // Funciones utilitarias
  ...
  // useEffect separado para cargar logs cuando se cambia a la pestaña de logs
  useEffect(() => {
    if (activeTab === 'logs' && isAuthenticated) {
      cargarLogs();
    }
  }, [activeTab, accionFiltro, tablaFiltro, fechaInicioFiltro, fechaFinFiltro, usuarioFiltro, busquedaLogs]);
