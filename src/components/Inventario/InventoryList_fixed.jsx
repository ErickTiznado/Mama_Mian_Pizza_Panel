...
const InventoryList = ({ inventoryData, onDataUpdate, loading }) => {
  ...
  return (
    <div className="ninv-inventory-list">
      ...
      {/* Modal para formulario de agregar/editar producto */}
      {showForm && (
        <div className="ninv-modal-overlay" onClick={(e) => e.target === e.currentTarget && resetForm()}>
          <div className="ninv-product-form-modal" onClick={(e) => e.stopPropagation()}>
